...
server = 'app-lb-355220616.eu-west-1.elb.amazonaws.com'
...
for i in range(1,5):
    ...
    r_get = requests.get('http://' + server + '/hello/'+user_name)
    ...
    r_put = requests.put('http://' + server + '/hello/'+user_name, json= {'dateOfBirth':birth_day})
